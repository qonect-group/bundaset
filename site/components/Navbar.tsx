...
export default function Navbar() {
  ...
  return (
    <div className="w-full relative sm:fixed sm:top-0 sm:bg-gray-900 z-50">
      {mobileMenu && (
        <div className="fixed top-16 z-50 h-screen w-full backdrop-blur-sm transition-opacity md:block hidden">
          <div ref={refMobileMenu}>
            <div className="px-3 py-6 bg-gray-900 border-b border-gray-800 flex gap-y-4 gap-x-3 flex-col">
              {menu.map((v, k) => {
                return (
            ...
            <div className="px-3 text-gray-400 py-3 bg-gray-900 border-b border-gray-800 w-full">
              <SearchBox />
            </div>
            <div className="px-3 text-gray-400 py-3 bg-gray-900 border-b border-gray-800 w-full flex flex-col gap-2">
              <Button>Login</Button>
      ...
      <div className="bg-gray-800 py-4 md:hidden">
        <div className="flex gap-10 max-w-6xl px-3 m-auto">
          {menu.map((v, k) => {
            return (
              <div
                key={k}
